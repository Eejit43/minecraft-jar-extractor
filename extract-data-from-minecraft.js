...
const OUT_DIR = 'minecraft-extracted-data';
...
module.exports = async (version) => {
    ...
    const cliStartCommand = isNewerThan118 ? `java -DbundlerMainClass=net.minecraft.data.Main -jar ${path.join(OUT_DIR, 'server.jar')}` : `java -cp ${path.join(OUT_DIR, 'server.jar')} net.minecraft.data.Main`; // cSpell:disable-line
