                ...
                advancements.push({
                    ...
                    criteria: Object.keys(advancementData.criteria).reduce((criteria, key) => {
                        ...
                        criteria[key] = {
                            ...
                            items:
                                condition.conditions.items?.map((item) => (item.tag ? `#${item.tag}` : item.items[0])) || //
                                condition.conditions.item?.items ||
                            ...
                            block:
                                ...
                                (condition.conditions.location?.block?.tag ? `#${condition.conditions.location.block.tag}` : undefined) ||
                                condition.conditions.player?.[0].predicate?.stepping_on?.block?.blocks?.[0],
                            ...
                            entities:
                                condition.conditions.entity?.map((entity) => entity.predicate.type || `#${entity.predicate.type_specific.variant}`) || //
                                ...
                                condition.conditions.victims?.map((entities) => entities[0].predicate.type) ||
                            ...
                            distance:
                                condition.conditions.distance || //
                                condition.conditions.entity?.[0]?.predicate?.distance ||
                                condition.conditions.projectile?.[0]?.predicate?.distance,
